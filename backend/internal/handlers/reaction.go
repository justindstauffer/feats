...
func (h *ReactionHandler) GetReactions(c *gin.Context) {
	...
	summaries, reactions, err := h.reactionService.GetReactions(postID)
	if err != nil {
...
func (h *ReactionHandler) AddReaction(c *gin.Context) {
	...
	reaction, isNew, err := h.reactionService.AddReaction(postID, userID, models.ReactionType(input.ReactionType))
	if err != nil {
...
func (h *ReactionHandler) RemoveReaction(c *gin.Context) {
	...
	err := h.reactionService.RemoveReaction(postID, userID)
	if err != nil {
